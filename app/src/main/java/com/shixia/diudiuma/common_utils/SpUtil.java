...
//            String token = getString(context, HttpConstants.TOKEN, "");
            // TODO: 2016/10/11 内容有误需修改
    ...
    public static boolean isSelf(Context context, long id) {
        return isSelf(context, Long.toString(id));
    }
    ...
    public static boolean isOnLogin(Context context) {
        return context != null && !(TextUtils.isEmpty(getString(context, "X-TOKEN", "")));
    }
    ...
    /**
     * desc:将16进制的数据转为数组 <p>创建人：聂旭阳 , 2014-5-25 上午11:08:33</p>
     *
     * @return modified:
     */
