...
//    public static final int EDIT_GOODS_REWARD_REQUEST_CODE = 0x004;
    ...
    protected void initContentView() {
        ...
        loserGoodsInfo.setType(2);      //该界面发布的为寻物启事
    ...
    protected void initListener() {
        ...
        etvQq.setOnEditItemClickListener(() -> presenter.toEditInfoPage(EDIT_GOODS_QQ_REQUEST_CODE, etvQq.getTvItemValue(), "QQ号", false, "您的QQ号", "QQ号可使失主更加方便的联系您，和您沟通~", R.drawable.img_hall_03));
