...
import static com.shixia.diudiuma.common_utils.Preconditions.checkNotNull;
 ...
 * <p>
 * Description:一款高效图片压缩工具类
 * AdvancedLuban —— Is a convenient simple Android image compression tool
 * library.Provides multiple compression strategies.Different calling
 * methods，Custom compression,Multi-Image synchronous compression and
 * so on,Focus on a better picture compression experience
 * <p>
 * Usage:
